...
class RPNLossComputation(object):
    ...
    def match_targets_to_anchors(self, anchor, target, copied_fields=[]):
        # (num_target, num_anchor)
        match_quality_matrix = boxlist_iou(target, anchor)
        # match_quality_matrix:[num_anchors] value:target_id/-1/-2
        ...
        # out of bounds
        # TODO: all the matched_idxs==-1/-2 matches target.bbox[0]
    ...
    def __call__(self, anchors, objectness, box_regression, targets):
        ...
        # label: (num_anchors,) -1-ignore 0-bg 1-fg
        # regression_targets: (num_anchors, 4)
        labels, regression_targets = self.prepare_targets(anchors, targets)
        # sampled_pos_inds: (num_anchors,)1 for chosen
