...
# ---------------------------------------------------------------------------- #
# RPN Attention options
# ---------------------------------------------------------------------------- #
_C.MODEL.RPN_ATT = CN()
_C.MODEL.RPN_ATT.USE_ATT = False
_C.MODEL.RPN_ATT.RPN_ATT_HEAD = 'FullAtt' 
...
_C.MODEL.ROI_REC_HEAD.NUM_CLASSES = 2
# alphabet file
...
# Uncertainty border estimation
_C.MODEL.ROI_UB_HEAD = CN()
...
_C.MODEL.ROI_UB_HEAD.BG_IOU_THRESHOLD = 0.5

_C.MODEL.ROI_UB_HEAD.FEATURE_EXTRACTOR = "UBRCNNFPNFeatureExtractor"
_C.MODEL.ROI_UB_HEAD.POOLER_RESOLUTION = 14
_C.MODEL.ROI_UB_HEAD.POOLER_SCALES = (1.0 / 16,)
_C.MODEL.ROI_UB_HEAD.POOLER_SAMPLING_RATIO = 0
_C.MODEL.ROI_UB_HEAD.CONV_LAYERS = (256, 256, 256, 256)

_C.MODEL.ROI_UB_HEAD.MLP_HEAD_DIM = 1024
_C.MODEL.ROI_UB_HEAD.UB_H_POINTS = 16
_C.MODEL.ROI_UB_HEAD.UB_W_POINTS = 16

_C.MODEL.ROI_UB_HEAD.PREDICTOR = "UBRCNNC4Predictor"
_C.MODEL.ROI_UB_HEAD.RESOLUTION = 14
_C.MODEL.ROI_UB_HEAD.BORDER_RATIO = 64
_C.MODEL.ROI_UB_HEAD.SHARE_BOX_FEATURE_EXTRACTOR = True
_C.MODEL.ROI_UB_HEAD.BO_WEIGHT = 1.0
_C.MODEL.ROI_UB_HEAD.Loss_balance = 1.2

_C.MODEL.ROI_UB_HEAD.DILATION = 1
_C.MODEL.ROI_UB_HEAD.USE_GN = False
...
# set -1 to shutdown this func
_C.SOLVER.EVAL_PERIOD = 100
_C.SOLVER.EVAL_BEGIN = 20000
...
# visualization LOTM mask
_C.TEST.VIS_LOTM = False
_C.TEST.VIS_DIR = "debug/vis_ctw_LOTM"
